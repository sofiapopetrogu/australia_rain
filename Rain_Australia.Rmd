...
# VIF: If the VIF value for a predictor variable is greater than 1, it indicates the presence of multicollinearity, suggesting that the predictor variable is highly correlated with other predictor variables in the model. 
...
print(a00)
#since the 2 features are highly correlated, we cannot see a clear separation of the classes in the scatter plot 
